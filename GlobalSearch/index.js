...
(function () {
  ...
  // Obsługa zarówno starego vendetta jak i nowego bunny/revenge API
  const _api = typeof bunny !== "undefined" ? bunny : typeof revenge !== "undefined" ? revenge : vendetta;
  const { findByProps, findByName } = _api.metro;
  const { after } = _api.patcher;
  const { React, ReactNative: RN } = _api.metro.common;
